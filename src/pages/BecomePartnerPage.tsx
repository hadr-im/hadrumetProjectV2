  ...
  if (status === "success") {
    return (
      <div className="min-h-screen pt-32 pb-12 flex items-center justify-center px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-md w-full bg-white rounded-3xl p-10 shadow-2xl shadow-blue-500/10 border border-gray-200 text-center space-y-6 animate-fade-in">
          <div className="w-20 h-20 bg-green-100 text-green-600 rounded-full flex items-center justify-center mx-auto">
            <Check size={40} />
          </div>
          <h2 className="text-3xl font-bold text-gray-900">Thank You!</h2>
          <p className="text-gray-600 leading-relaxed">
            Your partnership inquiry has been received. Our team will get back
            to you shortly to discuss how we can work together.
          </p>
          <button
            onClick={() => setStatus("idle")}
            className="w-full py-3 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold text-lg rounded-2xl shadow-xl shadow-blue-500/25 hover:shadow-blue-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-3 disabled:opacity-70 disabled:hover:scale-100"
          >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-600 font-light">
            Join us in creating impactful experiences. Fill out the form below
            and let's explore how we can collaborate on our upcoming events.
          </p>
        </div>

        <div className="bg-white/70 backdrop-blur-xl rounded-[2.5rem] p-8 md:px-12 shadow-2xl shadow-blue-900/5 border border-gray-200">
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:bg-white transition-all mt-2"
                  value={formData.name}
                  onChange={(e) =>
              ...
              <div className="grid grid-cols-1 mt-2 sm:grid-cols-2 gap-4">
                {events.map((event) => (
                  <button
                    ...
                    className={`flex items-center justify-between px-6 py-4 rounded-2xl border-2 transition-all duration-300 ${
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:bg-white transition-all resize-none mt-2"
